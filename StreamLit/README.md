...
- OpenRouter
  ...
  - Hosted model is currently fixed to `google/gemini-3.1-flash-lite-preview` to ensure concise and fast replies.
- Ollama
...
- OpenRouter calls failing: confirm your API key and base URL in Settings. Ensure the hosted model `google/gemini-3.1-flash-lite-preview` is available to your account.
